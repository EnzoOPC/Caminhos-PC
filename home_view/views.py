...
def login_required_for_forum(view_func):
...
class LoginView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Remova esta linha em produção e descomente o bloco abaixo
        ...
        # Verificação de senha normal - descomente após resolver o problema
    ...
    # Adicione esta função no arquivo views.py
